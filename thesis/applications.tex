...
\ttfamily{\IdrisFunction{noContradiction} \IdrisData{(}\IdrisBound{pfOfP}\IdrisData{,} \IdrisBound{pfOfNotP}\IdrisData{)} = \IdrisFunction{void} (\IdrisBound{pfOfNotP} \IdrisBound{pfOfP})} } when we compile the file:

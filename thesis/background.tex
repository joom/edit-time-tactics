...
\newcommand{\zip}{\IdrisFunction{\path{zip}}\ }
\subsection{Idris}
...
Idris programs elaborated from high-level Idris syntax trees into a core
...
monad that is called \path{Elab}. This monad holds a proof state that hosts
the context, proof term,

% first, indeptly of the implementation, what does elaborator do in the type theory
...
future versions.}, which embedded the proof tactics in a Haskell monad in the implementation.\cite{elabref}

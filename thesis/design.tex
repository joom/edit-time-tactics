...
When we place the cursor on \bn{t1} and run the case splitting action, this is
...
\subsection{Examples in action}\label{ssec:designExample}
...
\subsubsection{What \Editorable\ precludes}

...
string atom, then we know how to get a \ty{String} from it, otherwise we
...
We will discuss the implementation of the \Elab\ actinos for \fn{fromEditor}
...
term we give it, but it pretty prints it as \dt{1}.

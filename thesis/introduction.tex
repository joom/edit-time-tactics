...
\fn{green}, bound variables will be \bn{purple}, and metavariables and holes
will be \texttt{\IdrisMetavar{cyan}}.\footnote{We are following the color
...
% Licata\cite{licataOPLSS}. In \autoref{sec:rbt}, we first describe an Idris

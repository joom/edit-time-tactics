...
\begin{dedication}
  \epigraph{``When mathematics does not suffice, one turns to philosophy, faith, and principles, but when mathematics suffices one who turns to anything else is a bigot.''}{\textit{Ali Nesin}}
\end{dedication}

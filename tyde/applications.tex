...
defined in \autoref{code:collectTypes} for the compiler implementation. \TODO{should be resolved}
...
\fn{fresh}. We later use these names and make them
...
If we put the cursor on \fn{example} and execute the Emacs Lisp code somehow,
...
\TODO{Revise the implementation details, currently commented out}
...
% \subsubsection{Proof term generation}

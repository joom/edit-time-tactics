...
Then whenever users want to inform the compiler about the \sexp{}
...
\dt{:Nothing}. This can be generalized into all \ty{Maybe} types as follows:
...
defining a \ty{Show} instance for function types apply here \cite{showfunction},
...
piece of Idris code, i.e.\ concrete syntax, \fn{fromEditor} should parse the
...
The \ty{HasEditorPrim} predicate is used to define the new \Elab{} primitives:
...
%   and deserialize data before and after the action is run.

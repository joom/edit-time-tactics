...
instance of \ty{TTName} and runs \fn{fromEditor} from it on \dt{"ex1\_impl"}, which
results in the Idris name for \hole{ex1\_impl}. Then the compiler can run
...
\Editorable{} instance of \TT{} and run \fn{toEditor} from it on that term,
